...
var ASM_CONSTS = {
  102016: () => { if (document.fullscreenElement) return 1; },  
 102062: () => { return document.getElementById('canvas').width; },  
 102114: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102182: () => { document.exitFullscreen(); },  
 102209: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102282: () => { if (document.fullscreenElement) return 1; },  
 102328: () => { return document.getElementById('canvas').width; },  
 102380: () => { return screen.width; },  
 102405: () => { document.exitFullscreen(); },  
 102432: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102565: () => { if (document.fullscreenElement) return 1; },  
 102611: () => { return document.getElementById('canvas').width; },  
 102663: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102731: () => { if (document.fullscreenElement) return 1; },  
 102777: () => { return document.getElementById('canvas').width; },  
 102829: () => { return screen.width; },  
 102854: () => { if (document.fullscreenElement) return 1; },  
 102900: () => { return document.getElementById('canvas').width; },  
 102952: () => { return screen.width; },  
 102977: () => { document.exitFullscreen(); },  
 103004: () => { if (document.fullscreenElement) return 1; },  
 103050: () => { return document.getElementById('canvas').width; },  
 103102: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103170: () => { document.exitFullscreen(); },  
 103197: () => { return screen.width; },  
 103222: () => { return screen.height; },  
 103248: () => { return window.screenX; },  
 103275: () => { return window.screenY; },  
 103302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103483: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103554: () => { if (document.fullscreenElement) return 1; },  
 103600: () => { if (document.pointerLockElement) return 1; }
};
